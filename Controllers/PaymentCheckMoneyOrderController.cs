...
namespace Nop.Plugin.Payments.CheckMoneyOrder.Swedbank.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    [AutoValidateAntiforgeryToken]
    public class PaymentCheckMoneyOrderSwedbankController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentCheckMoneyOrderSwedbankController(ILanguageService languageService,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var checkMoneyOrderPaymentSettings = await _settingService.LoadSettingAsync<CheckMoneyOrderSwedbankPaymentSettings>(storeScope);
            ...
            return View("~/Plugins/Payments.CheckMoneyOrder.Swedbank/Views/Configure.cshtml", model);
        }
