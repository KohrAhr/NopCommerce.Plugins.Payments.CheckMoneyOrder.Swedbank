...
namespace Nop.Plugin.Payments.CheckMoneyOrder.Swedbank
{
    /// <summary>
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public CheckMoneyOrderPaymentProcessor(CheckMoneyOrderSwedbankPaymentSettings checkMoneyOrderPaymentSettings,
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentCheckMoneyOrderSwedbank/Configure";
        }
        ...
        {
            return "CheckMoneyOrder.Swedbank";
        }
        ...
        {
            //settings
            var settings = new CheckMoneyOrderSwedbankPaymentSettings
            {
        ...
        {
            //settings
            await _settingService.DeleteSettingAsync<CheckMoneyOrderSwedbankPaymentSettings>();

            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Payment.CheckMoneyOrder.Swedbank");
